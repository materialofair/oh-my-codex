...
- [ ] **File exists**: Skill folder at `~/.codex/skills/[name]/`, `<repo>/.agent/skills/local/[name]/`, or `<repo>/.codex/skills/[name]/`
- [ ] **SKILL.md present**: File named exactly `SKILL.md` (case-sensitive)
- [ ] **Folder name correct**: No spaces, special characters, or uppercase
- [ ] **Location visible**: `ls ~/.codex/skills/` shows the folder after installation
